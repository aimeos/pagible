import{_ as $,L as p,a3 as S,b as V,w as s,aB as q,o as f,a as l,aC as B,a6 as O,d as k,a9 as C,aa as I,l as w,t as o,ag as P,aD as L,f as r,c as v,F as D,a5 as T,aL as j,b2 as F,aM as R,a4 as J,r as y,V as H,e as E,I as Z,an as W,ax as z,aP as K,aQ as Q,aR as G,T as X,aS as Y,k as b,n as c,h as x,Z as _,m as ee,aI as M,aT as te,aE as ae,aJ as le,aK as A,aN as se,aO as U}from"./index-BPV2UoEN.js";import{F as ie,H as ne,A as re}from"./ElementListItems-BnqIwooF.js";const de={props:{item:{type:Object,required:!0}},emits:[],data:()=>({panel:[0,1,2],versions:{},element:{}}),setup(){return{auth:S()}},watch:{item:{immediate:!0,handler(e){!e.id||!this.auth.can("element:view")||this.$apollo.query({query:p`query ($id: ID!) {
              element(id: $id) {
                id
                bypages {
                  id
