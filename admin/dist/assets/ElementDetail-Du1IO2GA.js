import{_ as $,L as b,a5 as S,b as c,w as i,aF as A,o as f,a as l,aG as N,a8 as B,ac as k,ad as C,l as V,t as o,aj as U,aH as I,e as r,c as v,F as D,a7 as H,g as P,aQ as j,b6 as F,aR as R,a6 as J,r as y,V as T,d as E,H as W,aq as Z,ab as z,aU as G,aV as Q,aW as X,T as Y,aX as K,k as p,n as w,h as x,$ as _,m as ee,aM as L,aY as te,aI as ae,aN as le,aO as M,aS as ie,aT as q}from"./index-CuFWJGFn.js";import{F as se,H as ne,A as re}from"./ElementListItems-DX772XLm.js";const de={props:{item:{type:Object,required:!0}},emits:[],data:()=>({panel:[0,1,2],versions:{},element:{}}),setup(){return{auth:S()}},watch:{item:{immediate:!0,handler(e){!e.id||!this.auth.can("element:view")||this.$apollo.query({query:b`
              query ($id: ID!) {
                element(id: $id) {
                  id
                  bypages {
