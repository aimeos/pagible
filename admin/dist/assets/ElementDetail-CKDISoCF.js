import{_ as D,L as p,a3 as S,b as V,o as f,w as s,aA as q,a as l,aB as B,ad as O,d as k,ae as C,af as I,l as w,t as o,ag as P,aC as H,f as r,c as v,F as $,a5 as L,aD as F,a$ as j,aE as R,a4 as J,r as y,V as A,e as E,I as Z,ao as W,a7 as z,aI as G,aJ as K,aK as Q,T as X,aL as Y,k as b,n as c,h as x,Z as _,m as ee,aF as M,aN as te,aM as ae,ab as le,ac as T,aG as se,aH as U}from"./index-C2tWXbj5.js";import{F as ie,H as ne,A as re}from"./ElementListItems-XF3X6cdX.js";const de={props:{item:{type:Object,required:!0}},emits:[],data:()=>({panel:[0,1,2],versions:{},element:{}}),setup(){return{auth:S()}},watch:{item:{immediate:!0,handler(e){!e.id||!this.auth.can("element:view")||this.$apollo.query({query:p`query ($id: ID!) {
              element(id: $id) {
                id
                bypages {
                  id
