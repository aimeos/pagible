import{_ as $,L as p,a5 as S,b as V,w as s,aD as q,o as f,a as l,aE as N,a8 as B,d as k,ab as C,ac as I,l as w,t as o,ai as P,aF as L,f as r,c as v,F as D,a7 as T,aN as F,b4 as j,aO as R,a6 as J,r as y,V as H,e as E,I as W,ap as Z,az as z,aS as G,aT as K,aU as Q,T as X,aV as Y,k as b,n as c,h as x,a0 as _,m as ee,aK as M,aW as te,aG as ae,aL as le,aM as U,aQ as se,aR as A}from"./index-8Ib2nsHy.js";import{F as ie,H as ne,A as re}from"./ElementListItems-BigB2jVV.js";const de={props:{item:{type:Object,required:!0}},emits:[],data:()=>({panel:[0,1,2],versions:{},element:{}}),setup(){return{auth:S()}},watch:{item:{immediate:!0,handler(e){!e.id||!this.auth.can("element:view")||this.$apollo.query({query:p`query ($id: ID!) {
              element(id: $id) {
                id
                bypages {
                  id
