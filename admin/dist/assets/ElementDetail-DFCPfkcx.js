import{_ as $,L as b,a5 as S,b as c,w as i,aD as A,o as f,a as l,aE as O,a8 as N,ac as k,ad as C,l as V,t as o,aj as U,aF as I,e as r,c as v,F as D,a7 as P,g as H,aO as j,b4 as F,aP as R,a6 as J,r as y,V as L,d as E,H as W,aq as Z,ab as z,aS as G,aT as K,aU as Q,T as X,aV as Y,k as p,n as w,h as x,$ as _,m as ee,aK as T,aW as te,aG as ae,aL as le,aM as M,aQ as ie,aR as q}from"./index-BVc6zgPc.js";import{F as se,H as ne,A as re}from"./ElementListItems-CNuSs4fG.js";const de={props:{item:{type:Object,required:!0}},emits:[],data:()=>({panel:[0,1,2],versions:{},element:{}}),setup(){return{auth:S()}},watch:{item:{immediate:!0,handler(e){!e.id||!this.auth.can("element:view")||this.$apollo.query({query:b`
              query ($id: ID!) {
                element(id: $id) {
                  id
                  bypages {
