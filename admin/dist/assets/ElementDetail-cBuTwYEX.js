import{_ as $,L as p,a3 as S,b as V,o as f,w as s,ay as q,a as l,az as B,ac as O,d as k,ad as C,ae as I,l as w,t as o,af as P,aA as H,f as r,c as v,F as D,a5 as L,aB as F,a_ as j,aC as R,a4 as J,r as y,V as A,e as E,I as Z,am as z,a6 as W,aG as G,aH as K,aI as Q,T as X,aJ as Y,k as b,n as c,h as x,Z as _,m as ee,aD as T,aL as te,aK as ae,aa as le,ab as M,aE as se,aF as U}from"./index-BX1pNUVh.js";import{F as ie,H as ne,A as re}from"./ElementListItems-BlvDVBLU.js";const de={props:{item:{type:Object,required:!0}},emits:[],data:()=>({panel:[0,1,2],versions:{},element:{}}),setup(){return{auth:S()}},watch:{item:{immediate:!0,handler(e){!e.id||!this.auth.can("element:view")||this.$apollo.query({query:p`query ($id: ID!) {
              element(id: $id) {
                id
                bypages {
                  id
