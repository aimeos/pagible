import{_ as D,L as p,a3 as S,b as V,o as f,w as s,aB as q,a as l,aC as B,ac as O,d as k,ad as C,ae as I,l as w,t as o,af as P,ar as H,f as r,c as v,F as $,a5 as L,aD as F,a$ as j,aE as R,a4 as J,r as y,V as M,e as E,I as Z,ao as W,a6 as z,aI as G,aJ as K,aK as Q,T as X,aL as Y,k as b,n as c,h as x,Z as _,m as ee,aF as T,aN as te,aM as ae,aa as le,ab as A,aG as se,aH as U}from"./index-qpWCrkU6.js";import{F as ie,H as ne,A as re}from"./ElementListItems-C8-aF-jx.js";const de={props:{item:{type:Object,required:!0}},emits:[],data:()=>({panel:[0,1,2],versions:{},element:{}}),setup(){return{auth:S()}},watch:{item:{immediate:!0,handler(e){!e.id||!this.auth.can("element:view")||this.$apollo.query({query:p`query ($id: ID!) {
              element(id: $id) {
                id
                bypages {
                  id
