import{_ as D,L as p,a5 as S,b as V,w as s,aD as q,o as f,a as l,aE as N,a8 as B,ab as k,ac as C,l as w,t as o,ai as I,aF as P,e as r,c as v,F as $,a7 as H,g as L,aN as F,b4 as j,aO as R,a6 as J,r as y,V as T,d as E,H as W,ap as Z,az as z,aS as G,aT as K,aU as Q,T as X,aV as Y,k as b,n as c,h as x,$ as _,m as ee,aK as M,aW as te,aG as ae,aL as le,aM as U,aQ as se,aR as A}from"./index-ChaGvduw.js";import{F as ie,H as ne,A as re}from"./ElementListItems-BaafiFtL.js";const de={props:{item:{type:Object,required:!0}},emits:[],data:()=>({panel:[0,1,2],versions:{},element:{}}),setup(){return{auth:S()}},watch:{item:{immediate:!0,handler(e){!e.id||!this.auth.can("element:view")||this.$apollo.query({query:p`query ($id: ID!) {
              element(id: $id) {
                id
                bypages {
                  id
