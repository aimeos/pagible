import{_ as D,v as g,a3 as C,b as v,w as l,at as T,o as h,a as s,au as q,a5 as N,a9 as S,aa as $,m as y,t as o,ag as k,aY as U,f as n,c as b,F as E,B as I,h as H,aZ as O,a_ as F,a$ as j,a4 as J,r as p,V as L,d as w,M as Z,E as K,a8 as W,ar as z,ap as G,aq as Y,T as Q,as as X,l as f,n as V,i as x,aR as _,p as ee,al as P,ai as te,ah as ae,b0 as se,b1 as A,b2 as le,b3 as M}from"./index-Cbn9AHQW.js";import{F as ie,H as ne,A as re}from"./ElementListItems-ijgDpevO.js";import{F as de,G as oe,J as ue,K as me,L as he}from"./mdi-CS7WRiMD.js";const fe={props:{item:{type:Object,required:!0}},emits:[],data:()=>({panel:[0,1,2],versions:{},element:{}}),setup(){return{user:C()}},watch:{item:{immediate:!0,handler(e){!e.id||!this.user.can("element:view")||this.$apollo.query({query:g`
              query ($id: ID!) {
                element(id: $id) {
                  id
                  bypages {
