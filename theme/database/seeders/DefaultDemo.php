    ...
    protected function home( string $blogId ) : Page
    {
        ...
        $content = [
            ...
            ['id' => Utils::uid(), 'type' => 'pricing', 'group' => 'main', 'data' => [
                ...
                'items' => [
                    ['name' => 'Diagnostic', 'prices' => [['id' => 'diagnostic', 'amount' => '2–3 weeks']], 'text' => 'An independent assessment before a major commitment, recovery, or strategic reset.', 'features' => "- Evidence and stakeholder review\n- Decision and dependency map\n- Findings playback\n- Prioritised next steps", 'url' => '#contact', 'button' => 'Discuss a diagnostic'],
                    ['name' => 'Design+Launch', 'prices' => [['id' => 'launch', 'amount' => '6–10 weeks']], 'text' => 'A new operating model, service, or delivery approach built with your team.', 'features' => "- Current-state analysis\n- Design with operational owners\n- Tested routines and measures\n- Mobilisation plan", 'url' => '#contact', 'button' => 'Plan the work', 'highlight' => true, 'badge' => 'Typical engagement'],
                    ['name' => 'Delivery counsel', 'prices' => [['id' => 'counsel', 'amount' => 'Retained']], 'text' => 'Experienced challenge and support around a live change portfolio.', 'features' => "- Sponsor counsel\n- Independent delivery reviews\n- Decision preparation\n- Facilitation at critical points", 'url' => '#contact', 'button' => 'Talk about support'],
                ],
            ]],
            ['id' => Utils::uid(), 'type' => 'blog', 'group' => 'main', 'data' => [
