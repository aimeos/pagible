    ...
    protected function addCollection( Page $home ) : static
    {
        $this->page( [
            ...
            ['id' => 'pieces', 'type' => 'pricing', 'group' => 'main', 'data' => [
                ...
                'items' => [
                    ['name' => 'Orbit Coat', 'prices' => [['id' => 'standard', 'amount' => '1.680€', 'unit' => 'double-faced wool']], 'text' => 'A long wrap coat with an off-centre close, curved back seam, and hand-finished internal edges.', 'features' => "- Ink or mineral\n- Sizes 32–46\n- Edition of 36\n- Four-week delivery", 'file' => ['id' => $this->priceImg( 'coat' ), 'type' => 'file'], 'url' => '/visit', 'button' => 'Request a fitting', 'highlight' => true, 'badge' => 'Atelier signature'],
                    ['name' => 'Fold Jacket', 'prices' => [['id' => 'standard', 'amount' => '940€', 'unit' => 'undyed wool']], 'text' => 'Compact tailoring with a folded front, soft internal construction, and a clean sculpted shoulder.', 'features' => "- Natural charcoal or silver\n- Sizes 32–46\n- Edition of 48\n- Three-week delivery", 'file' => ['id' => $this->priceImg( 'jacket' ), 'type' => 'file'], 'url' => '/visit', 'button' => 'Request a fitting'],
                    ['name' => 'Column Dress', 'prices' => [['id' => 'standard', 'amount' => '1.120€', 'unit' => 'silk crepe']], 'text' => 'A full-length bias-cut dress with a high back, narrow straps, and a hem levelled after the cloth has settled.', 'features' => "- Ink, oxblood, or pearl\n- Sizes 32–46\n- Edition of 42\n- Three-week delivery", 'file' => ['id' => $this->priceImg( 'dress' ), 'type' => 'file'], 'url' => '/visit', 'button' => 'Request a fitting'],
                ],
            ]],
            ['id' => Utils::uid(), 'type' => 'heading', 'group' => 'main', 'data' => [
                'level' => 2,
