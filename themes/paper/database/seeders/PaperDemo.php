    ...
    protected function addSubscribe( Page $home ) : static
    {
        $this->page( [
            ...
            ['id' => Utils::uid(), 'type' => 'pricing', 'group' => 'main', 'data' => [
                ...
                'items' => [
                    ['name' => 'Reader', 'prices' => [['id' => 'annual', 'amount' => '24€', 'unit' => 'per year']], 'text' => 'The complete digital journal and our monthly letter from the editors.', 'features' => "- Every story online\n- Full issue archive\n- Monthly editors’ letter\n- Cancel at any time", 'url' => '#contact', 'button' => 'Choose Reader'],
                    ['name' => 'Print', 'prices' => [['id' => 'annual', 'amount' => '58€', 'unit' => 'per year']], 'text' => 'Four print issues, with full digital access included throughout the year.', 'features' => "- Four quarterly issues\n- Complete digital access\n- Monthly editors’ letter\n- Subscriber cover", 'url' => '#contact', 'button' => 'Choose Print', 'highlight' => true, 'badge' => 'Most chosen'],
                    ['name' => 'Sustainer', 'prices' => [['id' => 'annual', 'amount' => '96€', 'unit' => 'per year']], 'text' => 'Print and digital access with additional support for independent commissions.', 'features' => "- Everything in Print\n- Annual studio note\n- Your name in the year-end issue\n- Extra support for reporting", 'url' => '#contact', 'button' => 'Become a Sustainer'],
                ],
            ]],
