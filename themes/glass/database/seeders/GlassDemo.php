    ...
    protected function home( string $blogId ) : Page
    {
        ...
        $content = [
            ...
            ['id' => 'pricing', 'type' => 'pricing', 'group' => 'main', 'data' => [
                ...
                'items' => [
                    ['name' => 'Launch', 'prices' => [['id' => 'monthly', 'amount' => '$490', 'unit' => 'mo'], ['id' => 'annual', 'amount' => '$4,900', 'unit' => 'yr']], 'text' => 'For one team moving from spreadsheets to governed dashboards.', 'features' => "- 3 workspaces\n- 20 governed metrics\n- Warehouse and billing connectors\n- 90-day history", 'url' => '/docs', 'button' => 'Start setup'],
                    ['name' => 'Operate', 'prices' => [['id' => 'monthly', 'amount' => '$1,200', 'unit' => 'mo'], ['id' => 'annual', 'amount' => '$12,000', 'unit' => 'yr']], 'text' => 'For companies running weekly reviews from live data.', 'features' => "- 12 workspaces\n- Unlimited dashboards\n- Approval workflows\n- 24-month history\n- Priority support", 'url' => '/docs', 'button' => 'Plan rollout', 'highlight' => true, 'badge' => 'Most teams'],
                    ['name' => 'Control', 'prices' => [['id' => 'custom', 'amount' => 'Custom']], 'text' => 'For regulated teams with strict data residency and audit needs.', 'features' => "- Private region options\n- SSO and SCIM\n- Custom retention\n- Dedicated success review\n- Security questionnaire support", 'url' => '#contact', 'button' => 'Talk to sales'],
                ],
            ]],
            ['id' => Utils::uid(), 'type' => 'blog', 'group' => 'main', 'data' => [
