        ...
        $this->page( [
            ...
            ['id' => Utils::uid(), 'type' => 'pricing', 'group' => 'main', 'data' => [
                ...
                'items' => [
                    [
                        'name' => 'Digital',
                        'prices' => [['id' => 'monthly', 'amount' => '7€', 'unit' => 'month']],
                    ...
                    [
                        'name' => 'Magazine',
                        'prices' => [['id' => 'monthly', 'amount' => '12€', 'unit' => 'month']],
                    ...
                    [
                        'name' => 'Briefing',
                        'prices' => [['id' => 'monthly', 'amount' => '18€', 'unit' => 'month']],
...
SVG;
            ...
            $this->logoFile = $this->svgFile(
                ...
                'kontur-logo.svg',
                'Kontur logo',
                'Kontur wordmark with a gold accent line',
            );
        }
